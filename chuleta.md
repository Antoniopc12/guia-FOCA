...
**git reset**    	| &lt; --hard HEAD~1(Retrocedemos un commit y borramos los cambios)>    | Deshacer la operación de confirmar.
**git reset**    	| &lt; --soft HEAD~1(retrocedemos un commit pero no perdemos los cambios y se quedan almacenados para un futuro commit) >                                                                                     | Deshacer la operación de confirmar.
